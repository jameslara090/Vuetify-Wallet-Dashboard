              ...
              <v-row>
                <v-col cols="12" sm="12">
                  <v-toolbar flat color="rgba(0,0,0,0)" dark>
                    ...
                    <v-spacer></v-spacer>
                    <v-btn outlined>
                      <v-icon right class="mr-2">fas fa-sliders-h</v-icon>Filters
                    </v-btn>
                  </v-toolbar>
                </v-col>
                 <v-col cols="12" sm="4">
                       ...
                       <v-col cols="12" sm="8">
                         <v-list-item three-line>
                           <v-list-item-content>
                             ...
                             <v-list-item-title class="headline mb-1 white--text">$1200</v-list-item-title>
                       ...
                       <v-col cols="12" sm="8">
                         <v-list-item three-line>
                           <v-list-item-content>
                             ...
                             <v-list-item-title class="headline mb-1 white--text">$232.40</v-list-item-title>
                           ...
                           <v-list-item-content>
                             <div class="mb-4">
                              <v-btn tile fab color="#6e0b14" elevation="0">
                                <v-icon color="">fa fa-lira-sign</v-icon>
                              </v-btn>
                             </div>
                             <v-list-item-title class="headline mb-1 white--text">600</v-list-item-title>
                 ...
                 <v-col col="12" sm="8">
                    ...
                    <v-row>
                      <v-col cols="12" sm="2">
                        <v-btn fab class="ml-5 mt-2" color="grey lighten-1" small>
                          <v-icon>fa fa-long-arrow-alt-up</v-icon>
                        </v-btn>
                      </v-col>
                      <v-col cols="12" sm="2"><span class="white--text">Bitcoin</span></v-col>
                      <v-col cols="12" sm="2"><span class="white--text">10:42:23AM</span></v-col>
...
<style scoped>
 ...
 .cardVr{
  background: rgb(1,1,1);
    background: linear-gradient(90deg, rgba(1,1,1,1) 0%, rgba(34,34,29,1) 70%, rgba(19,158,112,1) 100%);
 }
 
 .cardR{
  background: rgb(1,1,1);
    background: linear-gradient(90deg, rgba(1,1,1,1) 0%, rgba(34,34,29,1) 70%, rgba(158,19,19,1) 100%);
 }
